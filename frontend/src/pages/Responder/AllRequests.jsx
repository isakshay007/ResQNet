// src/pages/Requests/AllRequests.jsx
import React, { useEffect, useState } from "react";
import api from "../../utils/api"; // axios wrapper with token handling
                ...
                <table className="w-full table-fixed border-collapse rounded-lg overflow-hidden shadow">
                  <thead>
                    <tr className="bg-teal-600 text-white text-left text-sm uppercase tracking-wider">
                      ...
                      <th className="p-3 w-[12%]">Requested Qty</th>
                      <th className="p-3 w-[12%]">Fulfilled Qty</th>
                      <th className="p-3 w-[12%]">Status</th>
                      <th className="p-3 w-[12%]">Disaster ID</th>
                      <th className="p-3 w-[22%]">Reporter</th>
                      <th className="p-3 w-[15%]">Created At</th>
                    </tr>
                  </thead>
                  <tbody>
                    {currentItems.map((r) => (
